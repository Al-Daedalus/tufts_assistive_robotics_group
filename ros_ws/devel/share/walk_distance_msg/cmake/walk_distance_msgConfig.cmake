...
if(NOT "/home/bill/bill_ros/ros_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'walk_distance_msg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bill/bill_ros/ros_ws/src/walk_distance_msg/${idir}'.  ${_report}")
    endif()

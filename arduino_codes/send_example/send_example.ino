...
void loop() {
  ...
  char packet[] = "Hello, RFM69!"; // the data you want to send.

  Serial.print("Sending: ");
  Serial.println(packet);

  if (radio.sendWithRetry(RECEIVER, packet, 14)) { //target node Id, message as string or byte array, message length
    Serial.println("OK");

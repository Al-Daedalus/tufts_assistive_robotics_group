cd /home/bill/bill_ros/bill_ws; source ./devel/setup.bash

gnome-terminal --tab -e '/bin/bash -c "cd /home/bill/bill_ros/bill_ws; source ./devel/setup.bash; rosrun rosserial_python serial_node.py /dev/imu_heading" '
...
gnome-terminal --tab -e '/bin/bash -c "cd /home/bill/bill_ros/bill_ws; source ./devel/setup.bash; roslaunch ar_track_alvar pr2_bundle_no_kinect.launch" '
#gnome-terminal --tab -e '/bin/bash -c "cd /home/bill/bill_ros/bill_ws; source ./devel/setup.bash;roslaunch bill_teleop_joy bill_joy.launch" '

...
(cl:in-package bill_encoder-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Encoder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bill_encoder-msg:<Encoder> is deprecated: use bill_encoder-msg:Encoder instead.")))

(cl:ensure-generic-function 'time_stamp-val :lambda-list '(m))
(cl:defmethod time_stamp-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bill_encoder-msg:time_stamp-val is deprecated.  Use bill_encoder-msg:time_stamp instead.")
  (time_stamp m))

(cl:ensure-generic-function 'left_encoder_count-val :lambda-list '(m))
(cl:defmethod left_encoder_count-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bill_encoder-msg:left_encoder_count-val is deprecated.  Use bill_encoder-msg:left_encoder_count instead.")
...
(cl:defmethod right_encoder_count-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bill_encoder-msg:right_encoder_count-val is deprecated.  Use bill_encoder-msg:right_encoder_count instead.")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Encoder>)))
  ...
  (cl:format cl:nil "float32 time_stamp~%int64 left_encoder_count~%int64 right_encoder_count~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Encoder)))
  "Returns full string definition for message of type 'Encoder"
  (cl:format cl:nil "float32 time_stamp~%int64 left_encoder_count~%int64 right_encoder_count~%~%~%"))

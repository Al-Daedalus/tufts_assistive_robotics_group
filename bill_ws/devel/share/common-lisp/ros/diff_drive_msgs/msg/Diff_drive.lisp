...
(cl:in-package diff_drive_msgs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Diff_drive>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Diff_drive)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name diff_drive_msgs-msg:<Diff_drive> is deprecated: use diff_drive_msgs-msg:Diff_drive instead.")))

(cl:ensure-generic-function 'time_stamp-val :lambda-list '(m))
(cl:defmethod time_stamp-val ((m <Diff_drive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diff_drive_msgs-msg:time_stamp-val is deprecated.  Use diff_drive_msgs-msg:time_stamp instead.")
  (time_stamp m))

(cl:ensure-generic-function 'left_wheel_vel-val :lambda-list '(m))
(cl:defmethod left_wheel_vel-val ((m <Diff_drive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diff_drive_msgs-msg:left_wheel_vel-val is deprecated.  Use diff_drive_msgs-msg:left_wheel_vel instead.")
  (left_wheel_vel m))

(cl:ensure-generic-function 'right_wheel_vel-val :lambda-list '(m))
(cl:defmethod right_wheel_vel-val ((m <Diff_drive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diff_drive_msgs-msg:right_wheel_vel-val is deprecated.  Use diff_drive_msgs-msg:right_wheel_vel instead.")
  (right_wheel_vel m))
